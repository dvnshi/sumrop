...
// New FullForm Div to place before the PieChart 
const FullFormDiv = styled.div` 
  text-align: center; 
  margin-bottom: 20px; 
  font-size: 1.5rem; 
  font-weight: bold; 
  ...
  return ( 
    <> 
      <div className="main"> 
        <Dashboard> 
          <ChartContainer> 
            {/* New FullFormDiv for SUMROP title and full form */} 
            <FullFormDiv> 
              SUMROP - Smart Urban Mobility & Resource Optimization Platform 
            </FullFormDiv> 
 
            {/* PieChart for Department Data */} 
